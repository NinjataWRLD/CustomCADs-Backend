using CustomCADs.Carts.Application.PurchasedCarts.Queries.Count.Carts;
using CustomCADs.Carts.Domain.PurchasedCarts.Reads;
using CustomCADs.Shared.Core.Common.TypedIds.Accounts;
using CustomCADs.UnitTests.Carts.Application.PurchasedCarts.Queries.Count.Carts.Data;

namespace CustomCADs.UnitTests.Carts.Application.PurchasedCarts.Queries.Count.Carts;
