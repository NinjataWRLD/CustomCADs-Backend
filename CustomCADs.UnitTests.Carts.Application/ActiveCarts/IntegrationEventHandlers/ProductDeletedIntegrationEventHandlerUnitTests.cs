using CustomCADs.Carts.Application.ActiveCarts.IntegrationEventHandlers;
...
namespace CustomCADs.UnitTests.Carts.Application.ActiveCarts.IntegrationEventHandlers;
...
public class ProductDeletedIntegrationEventHandlerUnitTests : ActiveCartsBaseUnitTests
{
    ...
    public async Task Handle_ShouldQueryDatabase_WhenThresholdNotReached()
    {
        ...
        ProductDeletedIntegrationEventHandler handler = new(reads.Object, uow.Object);
