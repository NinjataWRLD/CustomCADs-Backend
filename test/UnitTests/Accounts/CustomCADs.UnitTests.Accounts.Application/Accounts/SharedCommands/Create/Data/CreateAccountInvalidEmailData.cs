...
public class CreateAccountInvalidEmailData : CreateAccountData
{
    public CreateAccountInvalidEmailData()
    {
        ...
        Add(RolesData.ValidName3, ValidUsername3, InvalidEmail6, ValidTimeZone1, ValidFirstName1, ValidLastName1);
        Add(RolesData.ValidName3, ValidUsername3, InvalidEmail7, ValidTimeZone1, ValidFirstName1, ValidLastName1);
    }
}
