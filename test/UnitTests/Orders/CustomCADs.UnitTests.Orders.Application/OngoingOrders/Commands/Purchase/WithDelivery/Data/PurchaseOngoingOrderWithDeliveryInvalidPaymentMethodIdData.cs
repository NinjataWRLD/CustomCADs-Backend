...
public class PurchaseOngoingOrderWithDeliveryInvalidPaymentMethodIdData : PurchaseOngoingOrderWithDeliveryData
{
    ...
    {
        Add(string.Empty, 2.5, 2, "shipment-service-1", "Bulgaria", "Sofia", null, "customcads@gmail.com");
        Add(null!, 5.2, 5, "shipment-service-2", "Romania", "Bucharest", "+359359359359", null);
    }
}
