using CustomCADs.Speedy.API.Dtos.Block;
using CustomCADs.Speedy.API.Dtos.Complex;
using CustomCADs.Speedy.API.Dtos.Country;
using CustomCADs.Speedy.API.Dtos.Office;
using CustomCADs.Speedy.API.Dtos.PointOfInterest;
using CustomCADs.Speedy.API.Dtos.Site;
using CustomCADs.Speedy.API.Dtos.SpecialDeliveryRequirements;
using CustomCADs.Speedy.API.Dtos.State;
using CustomCADs.Speedy.API.Dtos.Street;
...
namespace CustomCADs.Speedy.Services.Location;
