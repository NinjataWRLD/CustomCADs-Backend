using CustomCADs.Speedy.API.Dtos.ShipmentSenderAndRecipient.ShipmentAddress;
using CustomCADs.Speedy.API.Dtos.ShipmentSenderAndRecipient.ShipmentPhoneNumber;
using CustomCADs.Speedy.Services.Models;

namespace CustomCADs.Speedy.Services;
