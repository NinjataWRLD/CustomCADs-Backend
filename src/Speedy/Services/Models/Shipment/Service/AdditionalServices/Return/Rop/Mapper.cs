using CustomCADs.Speedy.API.Dtos.ShipmentService.ShipmentAdditionalServices.ShipmentReturnAdditionalServices.ShipmentRopAdditionalService;

namespace CustomCADs.Speedy.Services.Models.Shipment.Service.AdditionalServices.Return.Rop;
