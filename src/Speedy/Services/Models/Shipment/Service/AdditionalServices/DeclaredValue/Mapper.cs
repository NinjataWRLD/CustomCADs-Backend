using CustomCADs.Speedy.API.Dtos.ShipmentService.ShipmentAdditionalServices.ShipmentDeclaredValueAdditionalService;

namespace CustomCADs.Speedy.Services.Models.Shipment.Service.AdditionalServices.DeclaredValue;
