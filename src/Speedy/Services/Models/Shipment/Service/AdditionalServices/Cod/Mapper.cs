using CustomCADs.Speedy.API.Dtos.ShipmentService.ShipmentAdditionalServices.ShipmentCodAdditionalService;

namespace CustomCADs.Speedy.Services.Models.Shipment.Service.AdditionalServices.Cod;
