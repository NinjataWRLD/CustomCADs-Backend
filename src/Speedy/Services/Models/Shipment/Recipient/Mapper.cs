using CustomCADs.Speedy.API.Dtos.ShipmentSenderAndRecipient.AutoSelectNearestOfficePolicy;
using CustomCADs.Speedy.API.Dtos.ShipmentSenderAndRecipient.ShipmentRecipient;

namespace CustomCADs.Speedy.Services.Models.Shipment.Recipient;
