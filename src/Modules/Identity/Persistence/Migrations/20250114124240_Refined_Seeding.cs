...
public partial class Refined_Seeding : Migration
{
	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.UpdateData(
			...
			columns: ["NormalizedUserName", "PasswordHash", "UserName"],
			values: ["PDMATSALIEV20", "AQAAAAIAAYagAAAAEGjQ1Zes3r2XJgjoHQykiyr11OgUEDw+YDnOKeENyN7Kqi9RWKKRCtwd7ZtEyywdYA==", "PDMatsaliev20"]);
	...
	protected override void Down(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.UpdateData(
			...
			keyValue: new Guid("af840410-f3f2-4a3b-d28a-08dd11623eb9"),
			columns: ["NormalizedUserName", "PasswordHash", "UserName"],
			values: ["PETARDMATSALIEV", "AQAAAAIAAYagAAAAEJNqqiC31XGVrNSSflDLpuNzs/PIzg8VXCyEOL2hqvWAYi8a37bn5CUxHdvVuszSsQ==", "PetarDMatsaliev"]);
