...
resource "aws_elastic_beanstalk_environment" "customcads_env_prod" {
  ...
  setting {
    ...
    namespace = "aws:autoscaling:launchconfiguration"
    resource  = null
    value     = "CustomCADsInstanceProfile"
  }
  setting {
  ...
  setting {
    ...
    resource  = null
    value     = "ivanangelov414@gmail.com"
  }
  setting {
  ...
  setting {
    ...
    namespace = "aws:elasticbeanstalk:sns:topics"
    resource  = null
    value     = "arn:aws:sns:us-east-1:535002872631:ElasticBeanstalkNotifications-Environment-CustomCADs-prod"
  }
  setting {
  ...
  setting {
    ...
    namespace = "aws:elasticbeanstalk:environment"
    resource  = null
    value     = "arn:aws:iam::535002872631:role/service-role/aws-elasticbeanstalk-service-role"
  }
  setting {
