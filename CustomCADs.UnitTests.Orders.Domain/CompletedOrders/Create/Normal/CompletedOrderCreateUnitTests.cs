...
public class CompletedOrderCreateUnitTests : CompletedOrdersBaseUnitTests
{
    ...
    public void Create_ShouldNotThrowException_WhenOrderIsValid(string name, string description, bool delivery, DateTime orderDate, AccountId buyerId)
    {
        CreateOrder(name, description, delivery, orderDate, buyerId);
    }

    [Theory]
    [ClassData(typeof(CompletedOrderCreateValidData))]
    public void Create_ShouldPopulateProperties(string name, string description, bool delivery, DateTime orderDate, AccountId buyerId)
    {
        var order = CreateOrder(name, description, delivery, orderDate, buyerId);
    ...
    public void Create_ShouldThrowException_WhenOrderIsInvalid(string name, string description, bool delivery, DateTime orderDate, AccountId buyerId)
    {
