...
public class CreateCompletedOrderInvalidDescriptionData : CreateCompletedOrderData
{
    ...
    {
        Add(ValidName1, InvalidDescription1, false, ValidOrderDate1, ValidBuyerId1, ValidDesignerId1, ValidCadId1);
        Add(ValidName2, InvalidDescription2, true, ValidOrderDate2, ValidBuyerId2, ValidDesignerId2, ValidCadId2);
    }
}
