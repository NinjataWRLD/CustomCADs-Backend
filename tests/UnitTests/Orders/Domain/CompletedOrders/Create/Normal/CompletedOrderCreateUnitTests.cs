...
public class CompletedOrderCreateUnitTests : CompletedOrdersBaseUnitTests
{
    ...
    public void Create_ShouldNotThrowException_WhenOrderIsValid(string name, string description, decimal price, bool delivery, DateTime orderedAt, AccountId buyerId)
    {
    ...
    [Theory]
    [ClassData(typeof(CompletedOrderCreateValidData))]
    public void Create_ShouldPopulateProperties(string name, string description, decimal price, bool delivery, DateTime orderedAt, AccountId buyerId)
    {
    ...
    public void Create_ShouldThrowException_WhenOrderIsInvalid(string name, string description, decimal price, bool delivery, DateTime orderedAt, AccountId buyerId)
    {
