...
public class CompletedOrderCreateWithIdInvalidOrderDateData : CompletedOrderCreateWithIdData
{
    ...
    {
        Add(ValidId1, ValidName1, ValidDescription1, ValidPrice1, true, InvalidOrderDate1, ValidBuyerId1);
        Add(ValidId2, ValidName2, ValidDescription2, ValidPrice2, false, InvalidOrderDate2, ValidBuyerId2);
    }
}
