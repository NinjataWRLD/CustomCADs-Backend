...
public class PurchaseActiveCartWithDeliveryInvalidCityData : PurchaseActiveCartWithDeliveryData
{
    ...
    {
        Add("payment-method-id-1", ValidBuyerId1, "shipment-service-1", "Bulgaria", string.Empty, "Slivnitsa", null, "customcads@gmail.com");
        Add("payment-method-id-2", ValidBuyerId2, "shipment-service-2", "Romania", null!, "Brailles", "+359359359359", null);
    }
}
