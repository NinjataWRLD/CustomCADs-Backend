...
public class PurchaseActiveCartWithDeliveryValidData : PurchaseActiveCartWithDeliveryData
{
    ...
    {
        Add("payment-method-id-1", "shipment-service-1", "Bulgaria", "Sofia", null, "customcads@gmail.com");
        Add("payment-method-id-2", "shipment-service-2", "Romania", "Bucharest", "+359359359359", null);
    }
}
