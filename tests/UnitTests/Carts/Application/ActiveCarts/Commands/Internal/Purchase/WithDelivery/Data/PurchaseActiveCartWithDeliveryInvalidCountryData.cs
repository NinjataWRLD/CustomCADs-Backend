...
public class PurchaseActiveCartWithDeliveryInvalidCountryData : PurchaseActiveCartWithDeliveryData
{
    ...
    {
        Add("payment-method-id-1", "shipment-service-1", string.Empty, "Sofia", null, "customcads@gmail.com");
        Add("payment-method-id-2", "shipment-service-2", null!, "Bucharest", "+359359359359", null);
    }
}
