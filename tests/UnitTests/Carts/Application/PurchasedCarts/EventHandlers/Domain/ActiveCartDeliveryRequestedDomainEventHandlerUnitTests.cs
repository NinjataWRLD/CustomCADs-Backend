using CustomCADs.Carts.Application.PurchasedCarts.EventHandlers.Domain;
...
namespace CustomCADs.UnitTests.Carts.Application.PurchasedCarts.EventHandlers.Domain;
