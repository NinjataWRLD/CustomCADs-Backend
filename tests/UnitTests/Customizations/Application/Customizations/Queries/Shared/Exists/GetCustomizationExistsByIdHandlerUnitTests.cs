using CustomCADs.Customizations.Application.Customizations.Queries.Shared.Exists;
using CustomCADs.Customizations.Domain.Repositories.Reads;
using CustomCADs.Shared.UseCases.Customizations.Queries;

namespace CustomCADs.UnitTests.Customizations.Application.Customizations.Queries.Shared.Exists;
