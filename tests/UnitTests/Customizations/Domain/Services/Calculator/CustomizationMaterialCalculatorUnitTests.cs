...
namespace CustomCADs.UnitTests.Customizations.Domain.Services.Calculator;

public class CustomizationMaterialCalculatorUnitTests : ServicesBaseUnitTests
{
	private readonly CustomizationMaterialCalculator calculator = new();
