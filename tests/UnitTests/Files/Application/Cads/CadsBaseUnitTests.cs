...
public class CadsBaseUnitTests
{
    ...
    protected static Cad CreateCadWithId(CadId? id = null, string key = ValidKey1, string contentType = ValidContentType1, decimal x1 = ValidCoord1, decimal y1 = ValidCoord1, decimal z1 = ValidCoord1, decimal x2 = ValidCoord2, decimal y2 = ValidCoord2, decimal z2 = ValidCoord2)
