...
using CustomCADs.UnitTests.Categories.Application.Categories.EventHandlers.Domain.Deleted.Data;

namespace CustomCADs.UnitTests.Categories.Application.Categories.EventHandlers.Domain.Deleted;
